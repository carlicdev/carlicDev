  ...
  return (
    <div className='max-w-lg my-14 mx-auto flex flex-col gap-7'>
        ...
        <div className='flex flex-col items-center'>
            <p className='font-black text-6xl tracking-tighter text-center capitalize'>libre.</p>
            <p className='font-black text-6xl tracking-tighter text-center capitalize'>indomable.</p>
            <p className='font-black text-6xl tracking-tighter text-center capitalize'>indestructible.</p> 
        </div>
